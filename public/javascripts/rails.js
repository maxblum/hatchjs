(function($, undefined) {
    ...
    $(function(){
        ...
        $('*[data-target-id]').on('ajax:success', function(e, html) {
            ...
            //find the remote panel in the ajax response
            var panel = $('> div[data-remote-id]:first-child', '<div>' + html + '</div>');

            if(panel.length > 0 && el.attr("data-remote-id")) el.replaceWith(panel);
            else el.html(html);
        });
    });
