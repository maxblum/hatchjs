...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      //automatically highlight the create-option if nothing is selected
      if (!this.result_highlight) {
        var createOption = this.search_results.find('.create-option');
        if(createOption.length > 0) this.result_do_highlight(createOption);
      }
