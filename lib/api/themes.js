...
function ThemesAPI(hatch) {
    ...
    this.defaults = {
        "title": "[default]",
        "thumbnail" : "http://localhost:3000/bootswatch/[default]/thumbnail.png",
        "variables" : "http://localhost:3000/bootswatch/[default]/variables.less",
        "bootswatch" : "http://localhost:3000/bootswatch/[default]/bootswatch.less"
    };
};
